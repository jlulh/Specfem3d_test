...
! http://www.geophysik.uni-jena.de/Lehre/Master+of+Science/Reflexionsseismik/SEG_Y+Trace+Header+Format.html
  ...
  header1(10) = NINT((x_found-x_found_source)*1.0d3)  ! offset
  header1(11) = NINT(z_found*1.0d3)                 ! elevation

  header1(13) = NINT(z_found_source*1.0d3)                ! source location (depth)
  header1(19) = NINT(x_found_source*1.0d3)                ! source location (X)
  header1(20) = NINT(y_found_source*1.0d3)                ! source location (Y)

  header1(21) = NINT(x_found*1.0d3)           ! receiver location xr
  header1(22) = NINT(y_found*1.0d3)           ! receiver location zr
